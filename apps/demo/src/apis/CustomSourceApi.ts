...
import { SourceApi, SourceApiInterface } from '@migration-planner-ui/api-client/apis';
...
export class CustomSourceApi extends SourceApi implements SourceApiInterface {
