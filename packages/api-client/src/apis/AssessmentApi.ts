...
export interface AssessmentApiInterface {
   ...
   */
  deleteAssessmentRaw(
    requestParameters: DeleteAssessmentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Assessment>>;
   ...
   */
  updateAssessmentRaw(
    requestParameters: UpdateAssessmentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Assessment>>;
...
export class AssessmentApi extends runtime.BaseAPI implements AssessmentApiInterface {
  ...
  async deleteAssessmentRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v1/assessments/{id}`.replace(
          `{${"id"}}`,
