...
import { HistogramFromJSON, HistogramFromJSONTyped, HistogramToJSON } from "./Histogram.js";
...
export function instanceOfVMResourceBreakdown(value: object): value is VMResourceBreakdown {
  ...
  if (
    !("totalForMigratableWithWarnings" in value) ||
    value["totalForMigratableWithWarnings"] === undefined
  )
    return false;
...
export function VMResourceBreakdownFromJSONTyped(
  json: any,
