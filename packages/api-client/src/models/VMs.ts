...
import { OsInfoFromJSON, OsInfoFromJSONTyped, OsInfoToJSON } from "./OsInfo.js";
...
export function VMsFromJSONTyped(json: any, ignoreDiscriminator: boolean): VMs {
  ...
  return {
    ...
    totalMigratableWithWarnings:
      json["totalMigratableWithWarnings"] == null ? undefined : json["totalMigratableWithWarnings"],
    cpuCores: VMResourceBreakdownFromJSON(json["cpuCores"]),
    diskSizeTier:
      json["diskSizeTier"] == null
        ? undefined
        : mapValues(json["diskSizeTier"], DiskSizeTierSummaryFromJSON),
    diskTypes:
      json["diskTypes"] == null ? undefined : mapValues(json["diskTypes"], DiskTypeSummaryFromJSON),
    distributionByCpuTier:
      json["distributionByCpuTier"] == null ? undefined : json["distributionByCpuTier"],
    distributionByMemoryTier:
      json["distributionByMemoryTier"] == null ? undefined : json["distributionByMemoryTier"],
...
export function VMsToJSON(value?: VMs | null): any {
  ...
  return {
    ...
    diskSizeTier:
      value["diskSizeTier"] == null
        ? undefined
        : mapValues(value["diskSizeTier"], DiskSizeTierSummaryToJSON),
    diskTypes:
      value["diskTypes"] == null ? undefined : mapValues(value["diskTypes"], DiskTypeSummaryToJSON),
