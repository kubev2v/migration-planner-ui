...
import { SnapshotFromJSON, SnapshotFromJSONTyped, SnapshotToJSON } from "./Snapshot.js";
...
export type AssessmentSourceTypeEnum =
  (typeof AssessmentSourceTypeEnum)[keyof typeof AssessmentSourceTypeEnum];
